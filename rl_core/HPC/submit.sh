...
#BSUB -J CleanRain[1-5]%5  # Job array with 5 tasks - remove the loop in the script if using this
#BSUB -n 4
...
python -m rl_core.clean_rainbow.train --exp-name "${LSB_JOBNAME}_${LSB_JOBINDEX}" --job-name $LSB_JOBNAME --job-index $LSB_JOBINDEX
# for i in {1..5}
# do
